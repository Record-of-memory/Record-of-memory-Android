...
import kr.co.app.recordOfMemory.databinding.ActivityDaybookWritingBinding
...
class DaybookWritingActivity :
	kr.co.app.recordOfMemory.config.BaseActivity<ActivityDaybookWritingBinding>(ActivityDaybookWritingBinding::inflate),
...
//					imageUri=getImageUri(this,thumbNail)
	...
	override fun onPatchRecordSuccess(response: kr.co.app.recordOfMemory.config.BaseResponse) {
...
//		startActivity(intent)
	...
	override fun onPostRecordSuccess(response: kr.co.app.recordOfMemory.config.BaseResponse) {
		dismissLoadingDialog()
		finish()
	}
